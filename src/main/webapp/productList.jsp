        ...
        <ul>
            <c:choose>
                <c:when test="${language.id == 2}">
                    ...
                    <li><a class="selected" href="categoryList">Магазин</a>
                    <li><a href="admin/login">Вы админ?</a>
                ...
                <c:otherwise>
                    ...
                    <li><a class="selected" href="categoryList">Shop</a>
                    <li><a href="admin/login">Admin login</a>
                    <li><a href="language?id=1">English</a></li>
                    <li><a href="language?id=2">Русский</a></li>
                </c:otherwise>
            </c:choose>
